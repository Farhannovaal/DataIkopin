...
@section('content')
        ...
        <div class="card">
            <div class="card-header">
                <button type="button" class="btn btn-sm btn-warning" onclick=" window.location='{{ url('dosen') }}'">
                    Back to main
                </button>
            </div>
            <div class="card-body">
    ...
    @endif
                    <form action="{{ url('dosen/'.$noDosen) }}" method="post">
                        @csrf
                        @method('PUT')
                        <form>
                         <div class="row mb-3">
                            <label for="noDosen" class="col-sm-2 col-form-label">noDosen</label>
                            <div class="col-sm-4">
                            <input type="text" class="form-control-plaintext" id="noDosen" name="noDosen" value="{{ $noDosen }}">
                        </div>
                         </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea  name="txtaddress" id="txtaddress" cols="30" rows="5" class="form-control @error('txtaddress')is-invalid @enderror" value="{{ $txtaddress }}"> {{ $txtaddress }}   </textarea>
                                    @error('txtaddress')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control form-control-sm @error('txtphone')is-invalid @enderror" id="txtphone" name="txtphone" value="{{ $txtphone }}">
                                        @error('txtphone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
